...
import { combine, condition, required, minLength, email, equalsField, validChars } from 'app/lib/form/validation'
...
const validations = {
  name: combine([required, validChars]),
  email: combine([required, email]),
  password: combine([required, minLength(6), validChars]),
